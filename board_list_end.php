   ...
   ?>
      ...
      <table>
         ...
         <?php
            ...
            $sql = "SELECT * FROM board where cond ='end' order by idx desc";
      ...
      <p class = "before_next_btn"> 
         <?php
            if($page != 1){
               $before = $page - 1;
               echo"<a href = 'board_list_end.php?page=$before'><img src = './img/before_icon.png'></a>";
            }
            for($i =1; $i <= $page_num; $i++){
               if($i == $page){
                  ...
                  echo"<a href = 'board_list_end.php?page=$i'>$i &nbsp;&nbsp;</a>";
               }
            }
            if($page != $page_num && $page_num >=2){
               $next = $page + 1;
               echo"<a href = 'board_list_end.php?page=$next'><img src = './img/after_icon.png'></a>";
            }
            echo"<br>";
         ?>
      </p>
      <button class = 'submit_btn' onclick = "location.href = 'board_list.php'">진행중인 프로젝트</button>
